...
if(isset($_GET['edit_product'])){
  ...
  $image2 = $_POST['image2'];
   ...
   $update_product_query = "UPDATE products SET pro_name = '$name', pro_price = '$price', cat_id = $category, brand_id = $brand, pro_des = '$description' , image1= $image1, image2 = $image2 WHERE pro_id = $pro_id ";
