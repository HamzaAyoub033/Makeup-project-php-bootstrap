<?php
define('PRODUCT_IMGAE_DIR', 'images/products');
...
if (isset($_POST['add_product'])) {
  ...
  if ($name == '' or $price == '' or $product_category == '' or $brand == '' or $description == '' or $image1 == '') {
...
values ('$name','$price', $product_category, $brand,'$description','$image1','$image2')";
...
<div id="content">
    ...
    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea id="product_name" name="desc" class="form-control input-md" required cols="8"
                    rows="9"></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-5">
                <button id="singlebutton" name="add_product" class="btn btn-primary" style="float:right;">ADD
                    PRODUCT</button>
